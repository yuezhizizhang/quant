...
d3.csv("data.csv", function(error, data) {
    ...
    var trendlineData = [
        { start: { date: new Date(2016, 3, 21), value: 2105.25 }, end: { date: new Date(2016, 11, 13), value: 2278.25 } },
    ...
    svg.select("g.ema.ma-0").datum(techan.indicator.ema().period(3)(data)).call(ema0);
    svg.select("g.ema.ma-1").datum(techan.indicator.ema().period(13)(data)).call(ema1);
    svg.select("g.ema.ma-2").datum(techan.indicator.ema().period(34)(data)).call(ema2);
